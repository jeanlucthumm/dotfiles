...
fp @ {
  ...
  # Any file can append an overlay here; this is the only place they apply.
  options.jl.overlays = lib.mkOption {
    type = lib.types.listOf lib.types.raw;
    default = [];
    description = "Overlays applied to the central per-system pkgs.";
  };
